...
In the space below, write the data type for the "id" column and the "seats" column (it's in light gray, offset by \< \>). **Answer** "id" is a <chr> type and "seats" is a <dbl> type.
...
1.  What department has the maximum seats? 

2.  How can you alphabetically organize the department, classes without using desc/asc?

3.  Which department has the highest mean seats?
