...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** There is now a 'reorder' function, reordering the months based on the total calls with x still = month. 
...
baltco_911_calls_by_date |>
  ...
  scale_x_date(date_breaks = "1 week", date_labels = "%b %d") +
  theme(
    axis.text.x = element_text(angle = 90,  hjust=1.1)
  )
```
